...
--synthesis_resources = 
 ...
 ENTITY  de2_70_cmd_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (77 DOWNTO 0);
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (77 DOWNTO 0);
		 src1_endofpacket	:	OUT  STD_LOGIC;
		 src1_ready	:	IN  STD_LOGIC;
		 src1_startofpacket	:	OUT  STD_LOGIC;
		 src1_valid	:	OUT  STD_LOGIC
	 ); 
 END de2_70_cmd_xbar_demux_002;

 ARCHITECTURE RTL OF de2_70_cmd_xbar_demux_002 IS
 ...
 END RTL; --de2_70_cmd_xbar_demux_002
