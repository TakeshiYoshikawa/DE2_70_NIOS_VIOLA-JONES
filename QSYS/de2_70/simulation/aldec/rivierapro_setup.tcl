...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                                              -work nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                       -work nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_agent.sv"                                                             -work nios2_processor_instruction_master_translator_avalon_universal_master_0_agent       
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                                         -work nios2_processor_jtag_debug_module_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_translator.sv"                                                        -work nios2_processor_instruction_master_translator                                       
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux_002 -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_003 -L rsp_xbar_demux_002 -L rsp_xbar_demux_001 -L rsp_xbar_demux -L cmd_xbar_mux_003 -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_003 -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L limiter -L id_router_003 -L id_router_002 -L id_router_001 -L id_router -L addr_router_002 -L addr_router_001 -L addr_router -L Pixel_Buffer_avalon_ssram_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -L sdram_s1_translator_avalon_universal_slave_0_agent_rdata_fifo -L sdram_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_processor_instruction_master_translator_avalon_universal_master_0_agent -L nios2_processor_jtag_debug_module_translator -L nios2_processor_instruction_master_translator -L Video_DMA -L Video_RGB_Resampler_0 -L Video_Scaler_0 -L Video_Clipper -L Video_Bayer_Pattern_Resampler -L Video_In_Decoder -L AV_Config -L sysid_qsys -L jtag_uart -L timer -L sdram -L Pixel_Buffer -L Video_Scaler_1 -L VGA_Controller -L Video_RGB_Resampler_1 -L Pixel_Buffer_DMA -L Dual_Clock_FIFO -L nios2_processor -L Clock_Signals -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
